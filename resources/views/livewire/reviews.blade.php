<div>
    ...
    <div class="mt-4 space-y-4 max-w-4xl mx-auto">
        ...
        <div class="reviews-swiper swiper mx-auto relative">
                        ...
                        <div class="p-10">
                            <div class="flex flex-col items-center text-center">
                                <div class="flex items-center mb-6">
                                    @for($i = 0; $i < 5; $i++)
                                        <svg class="w-6 h-6 {{ $i < $review->rating ? 'text-yellow-400' : 'text-gray-700' }}" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="flex items-center">
                                    <div class="h-12 w-12 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-white font-bold text-xl">
            ...
            <!-- Add Navigation -->
            <div class="swiper-button-next !w-12 !h-12 !bg-white/10 !rounded-full hover:!bg-white/20 transition-all duration-300 after:!text-2xl after:!text-white"></div>
            <div class="swiper-button-prev !w-12 !h-12 !bg-white/10 !rounded-full hover:!bg-white/20 transition-all duration-300 after:!text-2xl after:!text-white"></div>
            <!-- Add Pagination -->
