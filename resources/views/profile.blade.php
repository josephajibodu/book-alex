        ...
        <div class="relative mx-auto max-w-7xl">
            <div class="container px-6 py-20 mx-auto md:text-center md:px-4">
                ...
                <div class="flex flex-col md:flex-row md:space-x-8 mt-8">
                    ...
                    <div class="text-left md:w-1/2" data-aos="slide-left" data-aos-duration="1000">
                        <div class="mt-4 text-gray-200! trix-content" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-delay="200">
                            <h2 class="text-2xl mt-0! font-bold text-white">Description & Services</h2>
                            {!! $profile->intro !!}
                        </div>

                        <div class="mt-8 text-gray-200! trix-content" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-delay="400">
                ...
                <div class="mt-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
